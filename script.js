...
(function () {
  ...
  const PRODUCTS = [
    ...
    { id: 'mango-passion', name: 'Mango Passion', category: 'fruit-tea', desc: 'Refreshing mango and passion fruit tea, finished with a spoonful of popping boba.', price: 2500, tags: ['Refreshing'], bestSeller: true, c1: '#F6D18C', c2: '#C97D1E', icon: 'citrus', img: 'https://images.unsplash.com/photo-1781663904820-7a3a9623e0f7?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&q=80&w=500' },
    { id: 'strawberry-cloud', name: 'Strawberry Cloud', category: 'fruit-tea', desc: 'Strawberry milk tea, creamy foam and popping pearls in every sip.', price: 2700, tags: ['Popular'], bestSeller: true, c1: '#F3AFC2', c2: '#D6335C', icon: 'berry', img: 'https://images.unsplash.com/photo-1648580967255-d4beb1feed82?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&q=80&w=500' },
    ...
    { id: 'matcha-bloom', name: 'Matcha Bloom', category: 'matcha', desc: 'Premium matcha, fresh milk and brown sugar boba — our house signature.', price: 3000, tags: ['Signature'], bestSeller: true, c1: '#B9CE96', c2: '#43592C', icon: 'flower', img: 'https://images.unsplash.com/photo-1686794154608-e45c831ef567?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&q=80&w=500' },
