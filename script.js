...
(function () {
  ...
  const PRODUCTS = [
    ...
    { id: 'brown-sugar-bliss', name: 'Brown Sugar Bliss', category: 'milk-tea', desc: 'Brown sugar milk tea with chewy tapioca pearls, hand-striped for that signature look.', price: 2800, tags: ['Popular', 'Signature'], bestSeller: true, c1: '#BE7F3D', c2: '#8C5A24', icon: 'drizzle' },
    ...
    { id: 'mango-passion', name: 'Mango Passion', category: 'fruit-tea', desc: 'Refreshing mango and passion fruit tea, finished with a spoonful of popping boba.', price: 2500, tags: ['Refreshing'], bestSeller: true, c1: '#F6D18C', c2: '#C97D1E', icon: 'citrus' },
    { id: 'strawberry-cloud', name: 'Strawberry Cloud', category: 'fruit-tea', desc: 'Strawberry milk tea, creamy foam and popping pearls in every sip.', price: 2700, tags: ['Popular'], bestSeller: true, c1: '#F3AFC2', c2: '#D6335C', icon: 'berry' },
    ...
    { id: 'matcha-bloom', name: 'Matcha Bloom', category: 'matcha', desc: 'Premium matcha, fresh milk and brown sugar boba — our house signature.', price: 3000, tags: ['Signature'], bestSeller: true, c1: '#B9CE96', c2: '#43592C', icon: 'flower' },
  ...
  function renderBestSellers() {
    ...
    if (!grid) return;
    grid.innerHTML = PRODUCTS.filter((p) => p.bestSeller).map(createProductCard).join('');
  }
